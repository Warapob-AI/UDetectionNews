...
def NewsCheck(task: str, search: str):
    ...
    - **ความแม่นยำคือหัวใจ:** ใส่ใจในรายละเอียดเล็กๆ น้อยๆ เช่น วันที่, ตัวเลข, ชื่อเฉพาะ, และสถานที่ หาก "CLAIM" ระบุรายละเอียดผิดไปจาก "SEARCH RESULTS" ที่น่าเชื่อถือ ให้ถือว่าเป็นปัจจัยสำคัญในการพิจารณาว่าเป็น "ข่าวคลาดเคลื่อน" หรือ "ข่าวปลอม"
    ...
    for i, key in enumerate(valid_keys):
        print(f"--> กำลังลองใช้ Gemini API Key ลำดับที่ {i + 1}...")
        try:
